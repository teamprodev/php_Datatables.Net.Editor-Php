...
var pow_display_on_mobile = true;
var pow_hide_content_on_mobile = false; //only works if display_on_mobile set to false.
...
if(typeof powVars != 'undefined'){
    ...
    //jQuery(document).ready(function(){
        ...
        //CAS 8/6/14 Do not close unless they specifically close
...
function pow_listen_appear(){
    for(i in pow_widgets){
        ...
        //CAS 8/6/14 added to check if the element provided exists on the page then start out opened.
        var mydiv = document.getElementById(pow_widgets[i].element);
        if (mydiv != null)
            do_pullout(id);
        //CAS 8/6/14
